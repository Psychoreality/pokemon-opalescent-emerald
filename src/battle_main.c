...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_TUBER_F] = { _("Tuber"), 1, BALL_NET },
    [TRAINER_CLASS_TUBER_M] = { _("Tuber"), 1, BALL_NET },
    [TRAINER_CLASS_LADY] = { _("Lady"), 50 },
    [TRAINER_CLASS_BEAUTY] = { _("Beauty"), 20 },
    [TRAINER_CLASS_RICH_BOY] = { _("Rich Boy"), 50, BALL_LUXURY },
    [TRAINER_CLASS_POKEMANIAC] = { _("Pokémaniac"), 15, BALL_DREAM },
...
s32 GetWhichBattlerFasterArgs(struct BattleContext *ctx, bool32 ignoreChosenMoves, u32 speedBattler1, u32 speedBattler2, s32 priority1, s32 priority2)
{
    ...
    if (priority1 == priority2)
    {
        ...
        bool32 battler1HasStallingAbility = ctx->abilities[ctx->battlerAtk] == ABILITY_STALL;
        bool32 battler2HasStallingAbility = ctx->abilities[ctx->battlerDef] == ABILITY_STALL;
