...
const u8 gText_InfiniteRepelOn[] = _("The Infinite Repel was turned on.{PAUSE_UNTIL_PRESS}");
const u8 gText_InfiniteRepelOff[] = _("The Infinite Repel was turned off.{PAUSE_UNTIL_PRESS}");