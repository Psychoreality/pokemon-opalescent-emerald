...
static void RotomPhone_RotomRealityMenu_CreateCursorSprite(void)
{
    ...
    u8 y;
    u8 xOffset;
    LoadMonIconPalette(SPECIES_VOLTORB);
    ...
    sRotomPhone_StartMenu->menuRotomRealityCursorSpriteId = CreateMonIcon(SPECIES_VOLTORB, RotomPhone_RotomRealityMenu_CursorCallback,
        x,
        y,
        0, Random32()
    );
