...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_TURTWIG] =
    {
        ...
        .abilities = { ABILITY_HARVEST, ABILITY_WATER_COMPACTION, ABILITY_SHELL_ARMOR },
    ...
    [SPECIES_TORTERRA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_SOLID_ROCK, ABILITY_WATER_COMPACTION, ABILITY_SHELL_ARMOR },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_PIPLUP] =
    {
        ...
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_COMPETITIVE, ABILITY_SAVVY },
    #else
    ...
    [SPECIES_PRINPLUP] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_9
        .abilities = { ABILITY_DAZZLING, ABILITY_COMPETITIVE, ABILITY_SAVVY },
    #else
        .abilities = { ABILITY_TORRENT, ABILITY_NONE, ABILITY_DEFIANT },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_EMPOLEON] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_9
        .abilities = { ABILITY_QUEENLY_MAJESTY, ABILITY_SUPREME_OVERLORD, ABILITY_SAVVY },
    #else
        .abilities = { ABILITY_TORRENT, ABILITY_NONE, ABILITY_DEFIANT },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_STARAVIA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_RECKLESS, ABILITY_MOODY },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_STARAPTOR}),
    },
    ...
    [SPECIES_KRICKETOT] =
    {
        ...
        .abilities = { ABILITY_SAVVY, ABILITY_PUNK_ROCK, ABILITY_SWARM },
    ...
    [SPECIES_CRANIDOS] =
    {
        ...
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_SWORD_OF_RUIN, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_RAMPARDOS] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_INTREPID_SWORD, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SHIELDON] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_SOLID_ROCK, ABILITY_TABLETS_OF_RUIN, ABILITY_BATTLE_ARMOR },
    ...
    [SPECIES_BASTIODON] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_SOLID_ROCK, ABILITY_DAUNTLESS_SHIELD, ABILITY_BATTLE_ARMOR },
        .bodyColor = BODY_COLOR_GRAY,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_DRIFLOON] =
    {
        ...
        .abilities = { ABILITY_AFTERMATH, ABILITY_COMATOSE, ABILITY_SHADOW_TAG },
        .bodyColor = BODY_COLOR_PURPLE,
        .noFlip = TRUE,
    ...
    [SPECIES_BRONZOR] =
    {
        ...
        .abilities = { ABILITY_LEVITATE, ABILITY_HEATPROOF, ABILITY_LIGHT_METAL },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_GIBLE] =
    {
        ...
        .abilities = { ABILITY_SAND_RUSH, ABILITY_ROUGH_SKIN, ABILITY_STRONG_JAW },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Gible"),
        .cryId = CRY_GIBLE,
    ...
    [SPECIES_RIOLU] =
    {
        ...
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_SCRAPPY, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Riolu"),
        .cryId = CRY_RIOLU,
    ...
    [SPECIES_LUCARIO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_SCRAPPY, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SKORUPI] =
    {
        ...
        .abilities = { ABILITY_SHARPNESS, ABILITY_POISON_TOUCH, ABILITY_TOXIC_DEBRIS },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_CHEEK_POUCH, ABILITY_DRY_SKIN },
        .bodyColor = BODY_COLOR_BLUE,
