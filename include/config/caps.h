...
#define B_LEVEL_CAP_VARIABLE            0x40F8 // event variable used to derive level cap if B_LEVEL_CAP_TYPE is set to LEVEL_CAP_VARIABLE
...
#define B_EV_ITEMS_CAP                  0x24 // If set to true, EV-boosting items can't be used to go over the EV cap
