...
#define P_FLAG_EGG_MOVES                 0x46       // If this flag is set, enables egg move relearner.
#define P_FLAG_TUTOR_MOVES               0x47       // If this flag is set, enables tutor move relearner.
