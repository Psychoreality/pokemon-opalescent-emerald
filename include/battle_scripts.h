...
extern const u8 BattleScript_ShredderActivatesSub[];
extern const u8 BattleScript_ShredderActivatesScreens[];
...
extern const u8 BattleScript_DimensionTwisterActivates[];
