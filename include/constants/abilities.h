...
enum __attribute__((packed)) Ability
{
    ...
    //Custom
    ABILITY_NOBLE_AURA = ABILITIES_COUNT_GEN9,
    ABILITY_SHREDDER = 312,
    ABILITY_SAVVY = 313,
    ABILITY_STAR_PUPIL = 314,
    ABILITY_GENERALIST = 315,
    ABILITY_PERMAFROST = 316,
    ABILITY_DIMENSION_TWISTER = 317,
    ABILITY_PACK_TACTICS = 318,
    ABILITY_REFRACTION = 319,
    ABILITY_ETERNAL_FLAME = 320,
    ABILITIES_COUNT_CUSTOMINC,
    ABILITIES_COUNT = ABILITIES_COUNT_CUSTOMINC,
};
